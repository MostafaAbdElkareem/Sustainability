...
import vwizardStyle from "assets/jss/material-dashboard-pro-react/components/vwizardStyle.jsx";
import GridContainer from "components/Grid/GridContainer.jsx";
import GridItem from "components/Grid/GridItem.jsx";
import Save from "@material-ui/icons/SaveRounded";
import Cancel from "@material-ui/icons/CancelRounded";

class VWizard extends React.Component {
  constructor(props) {
    super(props);
    var width;
  ...
  refreshAnimation(index) {
    ...
    //var step_height = move_distance;
    move_distance = 89 * index_temp;
    ...
    var movingTabStyle = {
      width: "100%",
      transform: "translate3d(0px, " + move_distance + "px, 0)",
  ...
  render() {
    ...
    const stepsStyle = cx({
      [classes.removeSpacing]: true,
      [classes.topMarg]: true
    });
    return (
      <GridContainer>
        <GridItem xs={4} sm={2} className={stepsStyle}>
          <div className={classes.wizardNavigation}>
            <ul className={classes.nav}>
              {steps.map((prop, key) => {
                return (
                  <li className={classes.steps} key={key}>
                    <a
                      href="#pablo"
                    ...
                    >
                      <span className={classes.stepNo}>{prop.stepId}</span>{" "}
                      {prop.stepName}
                    </a>
                  </li>
                );
        ...
        <GridItem xs={8} sm={10} className={classes.removeSpacing}>
          <div className={classes.wizardContainer} ref="wizard">
            <Card className={classes.card}>
              <Button justIcon round color="info" className={classes.flotRight}>
              ...
              <div className={classes.footer}>
                <div className={classes.left}>
                  {this.state.previousButton ? <div /> : null}
                </div>
...
export default withStyles(vwizardStyle)(VWizard);
